...
namespace FoodLook_2
{
    ...
    public sealed partial class App : Application
    {
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            Windows.UI.ViewManagement.StatusBar.GetForCurrentView().BackgroundColor = Windows.UI.Color.FromArgb(255, 204, 0, 0);
            ...
            if (rootFrame == null)
            {
                ...
                rootFrame.Background = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 248, 248, 248));
            ...
            if (rootFrame.Content == null)
            {
                ...
                // навигации.
                if (Api.Settings.Values.ContainsKey(Api.Username) && Api.Settings.Values.ContainsKey(Api.Username))
                {
